...
public:
    ...
    bool runDVRAlgorithmWithSplitHorizon() {
        bool updated;
...
int main() {
    ...
    dvr.runDVRAlgorithmWithSplitHorizon();
    ...
    // Re-run the DVR algorithm after link failure with Split Horizon applied
    bool countToInfinity = dvr.runDVRAlgorithmWithSplitHorizon();
    ...
    cout << "Routing Tables after link failure with Split Horizon:\n";
    dvr.printRoutingTables();
